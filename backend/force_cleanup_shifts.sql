-- FORCE CLEANUP: Remove all invalid shifts and related data
-- This script will clean up all shifts outside working hours (8:00-12:00, 13:30-17:30)

BEGIN;

-- Step 1: Cancel appointments using invalid time slots
UPDATE appointments 
SET 
    status = 'cancelled',
...
-- Step 6: Verify cleanup - show remaining shifts
SELECT 
    id,
    name,
    start_time,
