...
_Tài liệu này là overview phục vụ thuyết trình. Phiên bản chi tiết (bao gồm error codes, schema validation, rate limiting) sẽ được bổ sung trong quá trình phát triển._
